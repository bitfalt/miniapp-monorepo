...
export function MembershipCard({ expiryDate, isActive, cost }: MembershipCardProps) {
  return (
    <div className="w-full bg-brand-secondary rounded-[30px] p-6 shadow-[0px_4px_4px_rgba(0,0,0,0.25)]">
      <div className="flex justify-between items-start mb-4">
        <h2 className="text-white text-3xl font-bold font-spaceGrotesk">
          Awaken Pro
        </h2>
        <div className="bg-brand-primary px-4 py-1 rounded-[20px] shadow">
